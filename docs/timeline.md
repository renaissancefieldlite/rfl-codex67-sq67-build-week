...
This timeline is the public-safe spine used in the white paper and video package.
...
| 2026-06-22 to 2026-06-23 | Public fix/PR arc referenced around noisy WebSocket and bridged log persistence. | RFL treats this as part of the public implementation-versus-documentation timeline. |
| 2026-07-11 | RFL identified and archived local Codex state/log evidence on the RFL Mac. | Three surfaces: `logs_2.sqlite`, `state_5.sqlite`, `.codex-global-state.json`. |
| 2026-07-13 to 2026-07-17 | SQ67 proof gates, sealed canaries, second-machine controls, and model-gate comparisons. | RFL converted the discovery into a measurable receipt/recovery harness. |
